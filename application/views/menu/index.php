                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <button href="" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="Edit" data-target="#editmenu<?= $m['id']; ?>">Edit</button>
                                <button onclick="hapusMenu('<?= base_url('menu/hapusmenu/') . $m['id']; ?>')" class="btn btn-danger btn-sm">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
